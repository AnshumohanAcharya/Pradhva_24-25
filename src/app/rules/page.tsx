        ...
        <div className="min-h-screen bg-gradient-to-br from-yellow-600 to-orange-600 p-8 text-black">
            <div className="max-w-4xl mx-auto bg-white bg-opacity-10 p-8 rounded-lg shadow-lg">
                ...
                <section className="mb-6">
                    ...
                    <ul className="list-disc list-inside">
                        <li>The athletic events for boys include <strong>100m</strong>, <strong>200m</strong>, <strong>400m</strong>, <strong>500m</strong>, <strong>800m</strong>, and <strong>1500m</strong> races.</li>
                    </ul>
                </section>
